...
export function criarEmbadTrabalhos(idUser) {
    const existente = document.getElementById("embad-geral");
    ...
    btnCadastrarTrabalho.addEventListener('click', () => {
        const nomeMateria = inputMateriaTrabalho.value;
        const nomeTrabalho = inputTrabalho.value;
        const data = inputDataTrabalho.value;
        ...
        if (nomeMateria.trim() !== '' && nomeTrabalho.trim() !== '' && data.trim() !== '') {
            ...
            inputMateriaTrabalho.value = '';
            inputTrabalho.value = '';
            inputDataTrabalho.value = '';
        } else {
...
export function criarEmbadProvas(idUser) {
    ...
    labelMateriaProva.setAttribute("for", "materiaP");
    ...
    inputMateriaProva.name = "materiaP";
    inputMateriaProva.id = "materiaP";
    ...
    btnCadastrarProva.addEventListener('click', () => {
        const nomeMateria = inputMateriaProva.value;
        const nomeProva = inputProva.value;
        const data = inputDataProva.value;
